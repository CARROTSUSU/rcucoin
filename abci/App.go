...
func (app *RCUCoinApp) DeliverTx(req abcitypes.RequestDeliverTx) abcitypes.ResponseDeliverTx {
    ...
    if err := json.Unmarshal(req.Tx, &tx); err != nil {
        return abcitypes.ResponseDeliverTx{Code: 1, Log: fmt.Sprintf("Invalid tx: %v", err)}
    }
...
func (app *RCUCoinApp) CheckTx(req abcitypes.RequestCheckTx) abcitypes.ResponseCheckTx {
    return abcitypes.ResponseCheckTx{Code: 0}
}

func (app *RCUCoinApp) Commit() abcitypes.ResponseCommit {
    return abcitypes.ResponseCommit{Data: []byte("rcucoin-commit")}
}
